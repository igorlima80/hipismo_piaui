class AddMenu < SeedMigration::Migration
  def up
    profissional = MenuItem.create name: 'Pessoa', icon: 'fab fa-user-check', link: '#', position: 1, target: '_self', permission: 'manage', permission_check: 'all', menu_item_id: nil, active_test: "", published: true
      ...
      MenuItem.create name: 'Benefícios', icon: 'fas fa-money-check-alt', link: 'benefit_types_path', position: 6, target: '_self', permission: 'manage', permission_check: 'benefit_types', menu_item: profissional, active_test: "controller_name == 'benefit_types'", published: true 
