class AddMenu < SeedMigration::Migration
  def up
    ...
    animal = MenuItem.create name: 'Animal', icon: 'fas fa-horse', link: '#', position: 2, target: '_self', permission: 'manage', permission_check: 'all', menu_item_id: nil, active_test: "", published: true  
      MenuItem.create name: 'Gerenciar', icon: 'fas fa-clipboard-list', link: 'animals_path', position: 2, target: '_self', permission: 'manage', permission_check: 'animals', menu_item: animal, active_test: "controller_name == 'animals'", published: true 
      
    school = MenuItem.create name: 'Escola', icon: 'fas fa-school', link: '#', position: 3, target: '_self', permission: 'manage', permission_check: 'all', menu_item_id: nil, active_test: "", published: true  
      MenuItem.create name: 'Matriculados', icon: 'fas fa-id-card', link: 'registrations_path', position: 4, target: '_self', permission: 'manage', permission_check: 'Registration', menu_item: school, published: true, active_test: "controller_name == 'registration'"  
      MenuItem.create name: 'Plano de Aulas', icon: 'fas fa-calendar-alt', link: 'class_plans_path', position: 5, target: '_self', permission: 'manage', permission_check: 'class_plans', menu_item: school, active_test: "controller_name == 'class_plans'", published: true 
